...
| hc06 | SC | target at far end (+0.055), two cards at 0.005 | | | | |
| hc07 | SC | far arm start (+pi) + card on rail 2 center | | | | |
| hc08 | SC | hc05 card pair, target moved to mid-rail 0.0 | | | | |
| hc09 | SC | board yaw -1.8: eval_config trial_3 verbatim | | | | |
